  ...
  return (
    <>
      ...
      <section className="max-w-6xl mx-auto px-6 mt-16">
        ...
        <h2 className="text-2xl font-semibold tracking-tight mt-3 mb-6 text-foreground">Выберите движок генерации</h2>
        <div className="flex gap-4 overflow-x-auto pb-2 -mx-6 px-6 snap-x" style={{ scrollbarWidth: 'none' }}>
          {models.map((m) => (
      ...
      <section className="max-w-6xl mx-auto px-6 mt-16">
        ...
        <h2 className="text-2xl font-semibold tracking-tight mt-3 mb-6 text-foreground">С чего начать?</h2>
