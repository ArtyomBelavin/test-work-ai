...
const photoModels = [
  {
    id: 'midjourney',
    name: 'Midjourney',
    desc: 'Лидер для арт-стилистики, иллюстраций и концепт-арта. Создавайте произведения искусства по текстовому описанию.',
  },
  ...
  return (
    ...
    >
        ...
        <div className="inline-flex gap-1 p-1 rounded-xl bg-muted/50 dark:bg-[rgba(255,255,255,0.06)]">
          <button
            ...
            className={cn(
              ...
              tab === 'photo' ? 'text-foreground font-medium' : 'text-muted-foreground',
            )}
      ...
      >
        ...
        <div className="md:w-[60%] p-6 grid grid-cols-2 md:grid-cols-3 gap-3" style={{ background: 'var(--seo-gradient-placeholder)' }}>
