  ...
  return (
    ...
    >
      <motion.div variants={fadeUp} className="text-center mb-10">
        ...
        <p className="text-base text-muted-foreground">ChatGPT, Claude, Gemini, DeepSeek — все модели в одном чате</p>
      </motion.div>
        ...
        >
          ...
          <div className="flex-1 space-y-4 mb-6">
            ...
            <div className="flex justify-start">
              ...
              >
                Конечно! Вот продающий текст для лендинга: «Откройте мир возможностей с нашим продуктом. Автоматизируйте рутинные задачи, экономьте
                время и увеличивайте продажи...»
              </div>
            </div>
          </div>

          <div className="flex items-center gap-2 rounded-xl px-4 py-3" style={{ background: 'var(--seo-pill-bg)' }}>
            ...
            {agents.map((a) => (
              ...
              >
                <div
                  ...
                  style={{ width: 44, height: 44, borderRadius: 12, background: 'rgba(232, 84, 32, 0.1)', color: 'hsl(var(--primary))' }}
                >
                  <a.Icon size={22} strokeWidth={1.75} />
                </div>
                <p className="text-[13px] font-semibold" style={{ color: 'var(--seo-heading)' }}>
                  {a.name}
                </p>
                <p className="text-[11px] mt-1" style={{ color: 'var(--seo-text-muted)' }}>
                  {a.desc}
                </p>
              </div>
            ))}
