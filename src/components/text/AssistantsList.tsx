    ...
    <section className="w-full">
      ...
      <div className="flex items-end justify-between mb-5">
        <div>
          ...
          <h2 className="text-[22px] font-bold tracking-tight" style={{ color: 'hsl(var(--foreground))' }}>
            Готовые ассистенты
          </h2>
          ...
          return (
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 12px 28px -16px rgba(232,84,32,0.45)'
              }}
              onMouseLeave={(e) => {
            ...
            >
              <div className="flex items-start gap-3">
                <div
                  ...
                  style={{
                    background: 'linear-gradient(135deg, rgba(232,84,32,0.18), rgba(255,122,61,0.08))',
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <h3 className="text-[14px] font-semibold truncate" style={{ color: 'hsl(var(--foreground))' }}>
                      {a.name}
                    </h3>
                    {a.isNew && (
                      <span
                  ...
                  <p className="text-[12.5px] leading-snug mt-1 line-clamp-2" style={{ color: 'hsl(var(--muted-foreground))' }}>
                    {a.description}
                  </p>
                </div>
