  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 text-sm">
        <span className="font-mono tabular-nums text-primary">от {model.credits} cr</span>
        <span className="text-muted-foreground/40">·</span>
        <span className="font-mono tabular-nums text-muted-foreground">~{approxSeconds[model.type]} сек</span>
      </div>
