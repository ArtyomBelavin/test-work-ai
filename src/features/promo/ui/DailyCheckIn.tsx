      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-xl font-bold text-foreground mb-1">Заходите 7 дней подряд</h2>
            <p className="text-sm text-muted-foreground mb-5">и получите до 33 кредитов бесплатно</p>
            ...
            >
              ...
              <span className="text-sm font-bold font-mono" style={{ color: 'hsl(var(--primary))' }}>
                +{current.credits} cr
              </span>
            </div>
                ...
                return (
                  <div key={d.day} className="flex flex-col items-center gap-1">
                    <div
                      ...
                      style={{
                        background: done ? 'hsl(var(--primary))' : active ? 'rgba(232,84,32,0.15)' : 'hsl(var(--secondary))',
                        border: active ? '1px solid hsl(var(--primary))' : '1px solid hsl(var(--border))',
                        color: done ? 'white' : active ? 'hsl(var(--primary))' : 'hsl(var(--muted-foreground))',
                      }}
                    >
                      {done ? <Check size={14} /> : d.isBonus ? <Gift size={14} /> : `+${d.credits}`}
                    </div>
                    <span className="text-[10px] text-muted-foreground">День {d.day}</span>
                  </div>
                )
              })}
            </div>
