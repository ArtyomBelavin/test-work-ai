    ...
    <AnimatePresence>
      {visible && (
        ...
        >
          ...
          <h3 className="text-[17px] font-semibold text-foreground leading-tight">−30% на тариф «Про»</h3>
          <p className="text-[13px] text-muted-foreground mt-1.5 leading-snug">Ваш персональный промокод на первый месяц</p>
