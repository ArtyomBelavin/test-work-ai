    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <p className="text-[13px] text-muted-foreground mt-1.5">и зарабатывайте бесплатные кредиты</p>

          <div className="grid grid-cols-2 gap-2.5 mt-5">
            <div className="rounded-[12px] p-3 text-left" style={{ background: 'hsl(var(--secondary))', border: '1px solid hsl(var(--border))' }}>
              ...
              <div className="text-[12px] font-mono font-semibold mt-1.5" style={{ color: 'hsl(var(--primary))' }}>
                +30 кредитов
              </div>
            </div>
            <div className="rounded-[12px] p-3 text-left" style={{ background: 'hsl(var(--secondary))', border: '1px solid hsl(var(--border))' }}>
          ...
          >
            <span className="flex-1 text-left text-[12px] font-mono text-foreground truncate">{refLink}</span>
            <button
              type="button"
              onClick={handleCopy}
