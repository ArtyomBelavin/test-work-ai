 ...
 */
export const Eyebrow = React.forwardRef<HTMLSpanElement, EyebrowProps>(({ children, className, ...props }, ref) => (
  <span
    ref={ref}
    className={cn(
    ...
    {...props}
  >
    <span className="size-1.5 rounded-full bg-primary" style={{ boxShadow: '0 0 10px hsl(var(--primary))' }} aria-hidden />
    {children}
  </span>
))
