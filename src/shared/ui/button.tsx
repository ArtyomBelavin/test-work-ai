  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        ghost: 'bg-card text-foreground rounded-full border border-[hsl(var(--border))] hover:bg-secondary hover:border-[hsl(20_17%_20%)]',
        quiet: 'text-muted-foreground hover:text-foreground bg-transparent rounded-full',
        outline: 'border border-[hsl(var(--border))] bg-transparent text-foreground rounded-full hover:bg-secondary hover:text-foreground',
        secondary: 'bg-secondary text-secondary-foreground rounded-full hover:bg-[hsl(15_13%_12%)]',
