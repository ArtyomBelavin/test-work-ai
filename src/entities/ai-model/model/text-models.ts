    ...
    subModels: [
      {
        ...
        credits: 0,
        badge: 'WEB',
        description: 'Веб-поиск и анализ ссылок в реальном времени',
        hasWeb: true,
        hasImages: true,
      },
      { id: 'gpt-4.1', name: 'GPT-4.1', credits: 3, description: 'Производительная модель для повседневных задач', hasFiles: true, hasImages: true },
      {
        ...
        credits: 1,
        badge: '∞ FAST',
        description: 'Быстрая и экономная версия 4.1',
        hasFiles: true,
        hasImages: true,
      },
      { id: 'gpt-4.1-nano', name: 'GPT-4.1 Nano', credits: 1, badge: '∞ FAST', description: 'Ультрабыстрая, минимальные задачи', hasFiles: true },
      {
        ...
        credits: 6,
        badge: 'TOP',
        description: 'Флагман GPT — умный и быстрый',
        isNew: true,
        hasFiles: true,
        hasImages: true,
      },
      ...
      { id: 'gpt-5.4', name: 'GPT 5.4', credits: 10, badge: 'TOP', description: 'Топовый GPT для сложных задач', hasFiles: true, hasImages: true },
      {
        ...
        credits: 15,
        badge: 'PRO',
        description: 'Максимальная мощность OpenAI',
        hasFiles: true,
        hasImages: true,
      },
    ],
  },
  {
    ...
    subModels: [
      ...
      { id: 'claude-4.5-sonnet', name: 'Claude 4.5 Sonnet', credits: 1, badge: 'NEW', description: 'Новый Sonnet 4.5', isNew: true, hasFiles: true },
      {
        ...
        credits: 5,
        badge: 'NEW',
        description: 'Топовый Claude апрель 2026',
        isNew: true,
        hasFiles: true,
      },
      {
        ...
        credits: 6,
        badge: 'NEW',
        description: 'Новейший флагман Anthropic',
        isNew: true,
        hasFiles: true,
      },
      {
        ...
        credits: 2,
        badge: 'NEW',
        description: 'Новейший Sonnet 4.6',
        isNew: true,
        hasFiles: true,
      },
    ],
    ...
    subModels: [
      {
        ...
        credits: 1,
        badge: '∞ FAST',
        description: 'Быстрый и мультимодальный',
        hasFiles: true,
        hasImages: true,
      },
      {
        ...
        credits: 1,
        badge: 'NEW',
        description: 'Самая мощная версия с высокой точностью',
        isNew: true,
        hasFiles: true,
        hasImages: true,
      },
      {
        ...
        credits: 2,
        badge: 'TOP',
        description: 'Gemini 3 — сложные задачи и большие данные',
        hasFiles: true,
        hasImages: true,
      },
      {
        ...
        credits: 3,
        badge: 'NEW',
        description: 'Превью новейшего Gemini',
        isNew: true,
        hasFiles: true,
        hasImages: true,
      },
  ...
  },
  {
    ...
    subModels: [
      { id: 'perplexity-sonar', name: 'Perplexity Sonar', credits: 1, badge: '∞ FAST', description: 'Быстрый поиск с цитатами', hasWeb: true },
      {
        ...
        credits: 2,
        badge: 'WEB',
        description: 'Расширенный поиск с анализом',
        hasWeb: true,
      },
      {
        ...
        credits: 5,
        badge: 'WEB',
        description: 'Глубокое исследование с отчётом',
        hasWeb: true,
      },
    ],
  },
  {
    ...
    subModels: [
      { id: 'qwen-3', name: 'Qwen 3', credits: 1, description: 'Флагманская языковая модель Alibaba' },
      {
        ...
        credits: 2,
        badge: 'THINK',
        description: 'Версия с пошаговым рассуждением',
        hasThinking: true,
      },
      {
        ...
        credits: 3,
        badge: 'MAX',
        description: 'Максимальная мощность + мышление',
        hasThinking: true,
      },
    ],
  },
