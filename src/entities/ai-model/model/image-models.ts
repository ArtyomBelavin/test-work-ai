...
export const imageProviders: ImageProvider[] = [
  {
    ...
    badgeColor: 'yellow',
    description:
      'Нашумевшая нейросеть от Google: Gemini Flash 3.0 Banana. Загрузите до 14 изображений вместе с запросом, чтобы использовать режим Remix',
    subModels: [
  ...
  },
  {
    ...
    badgeColor: 'orange',
    description:
      'Полный функционал MidJourney для генерации изображений. Выберите версию модели и настройте параметры. Загрузите изображение для задания стиля.',
    subModels: [{ id: 'mj-8', name: 'MidJourney', credits: 80, isDefault: true, desc: 'Топ для арта', time: '30 сек' }],
  ...
  },
  {
    ...
    badgeColor: 'green',
    description:
      'Seedream 5.0 (Lite) — единая мультимодальная модель ByteDance для генерации из текста, генерации по изображению, переноса стиля и редактирования.',
    subModels: [
  ...
  },
  {
    ...
    badgeColor: 'purple',
    description:
      'Создавайте или редактируйте изображения в нейросети Sora Images (она же GPT Images) от OpenAI. Загрузите до 5 изображений для режима Remix.',
    subModels: [{ id: 'gpt-image-1.5', name: 'GPT Image 1.5', credits: 40, isDefault: true, desc: 'От OpenAI', time: '20 сек', badge: 'PRO' }],
  ...
  },
  {
    ...
    badgeColor: 'blue',
    description:
      'Набор моделей Flux для генерации изображений претендует на звание SOTA (state of the art), что является статусом лучших в индустрии.',
    subModels: [{ id: 'flux-1', name: 'Flux', credits: 15, isDefault: true, desc: 'State of the art', time: '15 сек' }],
  ...
  },
  {
    ...
    badgeColor: 'pink',
    description:
      'Генерируйте изображения в популярной нейросети Runway Frames при помощи текстовых запросов с различными уникальными стилями или загружайте до 3 изображений.',
    subModels: [{ id: 'runway-frames', name: 'Runway', credits: 20, isDefault: true, desc: 'Креативная генерация', time: '20 сек' }],
  ...
  },
  {
    ...
    badgeColor: 'blue',
    description:
      'Создавайте фотореалистичные изображения с точной типографикой и мельчайшими деталями за считанные секунды с помощью Imagen 4 от Google.',
    subModels: [{ id: 'imagen-4', name: 'Imagen 4', credits: 8, isDefault: true, desc: 'От Google', time: '15 сек' }],
    aspectRatios: ['1:1', '16:9', '9:16', '4:3', '3:4'],
    maxUploads: 0,
    quantityOptions: [1, 2, 3, 4],
  },
  {
    ...
    subModels: [{ id: 'higgsfield-soul', name: 'Higgsfield Soul', credits: 15, isDefault: true, isNew: true, desc: 'Новая модель', time: '20 сек' }],
  ...
  },
  {
    ...
    subModels: [{ id: 'kling-v3-omni', name: 'Kling V3 Omni', credits: 25, isDefault: true, isNew: true, desc: 'Мультимодальная', time: '20 сек' }],
    aspectRatios: ['1:1', '16:9', '9:16', '4:3', '3:4'],
    maxUploads: 0,
    quantityOptions: [1, 2, 3, 4],
