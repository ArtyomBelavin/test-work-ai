...
export const videoProviders: VideoProvider[] = [
  ...
  },
  {
    ...
    icon: '🌊',
    badge: 'Google',
    subModels: [{ id: 'veo-3', name: 'Veo 3', credits: 120, isNew: true, isDefault: true, desc: 'Топовая модель Google', time: '120 сек' }],
  ...
  },
  {
    ...
    icon: '🌊',
    badge: 'Open Source',
    subModels: [{ id: 'wan-2.1-video', name: 'Wan AI', credits: 30, isDefault: true, desc: 'Открытая модель', time: '90 сек' }],
    aspectRatios: ['16:9', '9:16', '1:1'],
  ...
  },
  {
    ...
    icon: '🎬',
    badge: 'NEW',
    subModels: [{ id: 'hailuo', name: 'Hailuo AI', credits: 40, isNew: true, isDefault: true, desc: 'Новый игрок', time: '90 сек' }],
    aspectRatios: ['16:9', '9:16', '1:1'],
    durationOptions: ['5s', '8s'],
    resolutionOptions: ['720p', '1080p'],
  },
  {
    ...
    icon: '🎬',
    badge: 'NEW',
    subModels: [{ id: 'vidu', name: 'Vidu AI', credits: 40, isNew: true, isDefault: true, desc: 'Новый игрок', time: '90 сек' }],
    aspectRatios: ['16:9', '9:16', '1:1', '4:3'],
    durationOptions: ['5s', '8s'],
    resolutionOptions: ['720p', '1080p'],
  },
...
export const videoGridCards: VideoGridCard[] = [
  { providerId: 'kling', subModelId: 'kling-3.0', label: 'Kling 3.0', shortDesc: 'Топовое видео от Kling AI', credits: 75, isNew: true, icon: '🎬' },
  {
    ...
    subModelId: 'seedance-2.0',
    label: 'Seedance 2.0',
    shortDesc: 'Кинематографичный мир',
    credits: 48,
    isNew: true,
    icon: '📊',
  },
