import { imageCarouselCards, imageGridCards, imagePromptSuggestions } from '../model/image-models'
import { textQuickActions } from '../model/text-models'
import { videoCarouselCards, videoGridCards, videoPromptSuggestions } from '../model/video-models'
...
export async function getTextQuickActions(): Promise<AiCatalogQuickAction[]> {
  return httpClient
    .get<AiCatalogQuickActionDto[] | ApiListDto<AiCatalogQuickActionDto>>(AI_CATALOG_ENDPOINTS.textQuickActions)
...
export async function getImageGridCards(): Promise<AiCatalogGridCard[]> {
  return httpClient
    .get<AiCatalogGridCardDto[] | ApiListDto<AiCatalogGridCardDto>>(AI_CATALOG_ENDPOINTS.imageGridCards)
...
export async function getImageCarouselCards(): Promise<AiCatalogCarouselCard[]> {
  return httpClient
    .get<AiCatalogCarouselCardDto[] | ApiListDto<AiCatalogCarouselCardDto>>(AI_CATALOG_ENDPOINTS.imageCarouselCards)
...
export async function getImagePromptSuggestions(): Promise<AiCatalogPromptSuggestion[]> {
  return httpClient
    .get<AiCatalogPromptSuggestionDto[] | ApiListDto<AiCatalogPromptSuggestionDto>>(AI_CATALOG_ENDPOINTS.imagePromptSuggestions)
...
export async function getVideoGridCards(): Promise<AiCatalogGridCard[]> {
  return httpClient
    .get<AiCatalogGridCardDto[] | ApiListDto<AiCatalogGridCardDto>>(AI_CATALOG_ENDPOINTS.videoGridCards)
    .then((response) => unwrapList(response).map(mapAiCatalogGridCardDto))
    .catch(() => {
...
export async function getVideoCarouselCards(): Promise<AiCatalogCarouselCard[]> {
  return httpClient
    .get<AiCatalogCarouselCardDto[] | ApiListDto<AiCatalogCarouselCardDto>>(AI_CATALOG_ENDPOINTS.videoCarouselCards)
    .then((response) => unwrapList(response).map(mapAiCatalogCarouselCardDto))
    .catch(() => {
...
export async function getVideoPromptSuggestions(): Promise<AiCatalogPromptSuggestion[]> {
  return httpClient
    .get<AiCatalogPromptSuggestionDto[] | ApiListDto<AiCatalogPromptSuggestionDto>>(AI_CATALOG_ENDPOINTS.videoPromptSuggestions)
    .then((response) => unwrapList(response).map(mapAiCatalogPromptSuggestionDto))
    .catch(() => {
