...
import { mapGalleryCollectionDto, mapGalleryItemDto, type GalleryCollection, type GalleryItem } from './gallery.mapper'
...
function createFallbackItems(): GalleryItem[] {
  ...
  return (Object.entries(collections) as [GalleryCollectionType, string[]][]).flatMap(([collection, items]) =>
