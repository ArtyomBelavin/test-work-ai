    ...
    <div className="min-w-0">
      ...
      <section className="relative overflow-hidden">
        <div
          ...
          style={{
            background: 'radial-gradient(ellipse 80% 100% at 50% 0%, rgba(232,84,32,0.18) 0%, rgba(255,122,61,0.06) 40%, transparent 70%)',
          }}
        />
        <motion.div
        ...
        <div className="relative max-w-[780px] mx-auto px-4 pb-16 md:pb-24">
          <PromptWindow type={genType} onTypeChange={setGenType} prompt={prompt} onPromptChange={setPrompt} onGenerate={handleGenerate} />
        </div>
            ...
            <div className="flex-1 space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">Следите за новостями и обновлениями в наших каналах.</p>
                </div>
              </div>
            </div>
          </div>
