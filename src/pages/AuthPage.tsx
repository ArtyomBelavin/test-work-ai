...
const AuthPage = () => {
  ...
  return (
    <div
      ...
      style={{
        background: 'radial-gradient(ellipse 80% 60% at 50% 0%, rgba(232,84,32,0.12) 0%, transparent 60%), hsl(var(--background))',
      }}
    >
      <div
      ...
      >
        ...
        <h1 className="text-2xl font-bold text-center text-foreground mb-2">{mode === 'login' ? 'Вход в ERA2' : 'Создать аккаунт'}</h1>
        <p className="text-sm text-muted-foreground text-center mb-7">
          {mode === 'login' ? '90+ нейросетей в одном месте' : 'Получите 100 бесплатных кредитов при регистрации'}
        </p>
