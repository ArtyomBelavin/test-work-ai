      ...
      <div className="flex-1 px-4 md:px-8 py-6 space-y-6 overflow-y-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm max-w-xl">44 ИИ-ассистента для любых задач</p>
          </div>
        </motion.div>
        ...
        {filtered.length === 0 && <p className="text-center text-muted-foreground py-12">Агенты не найдены</p>}
      </div>
