...
import { imageProviders, imageCarouselCards, imagePromptSuggestions } from '@/entities/ai-model'
...
const welcomeScenarios: WelcomeScenario[] = [
  {
    ...
    prompt:
      'Photorealistic portrait of a young woman, soft studio lighting, shallow depth of field, 85mm lens, high detail skin texture, natural makeup',
  ...
  },
  {
    ...
    prompt:
      'Cyberpunk city at night, neon lights, rain reflections on wet streets, holographic billboards, blade runner atmosphere, cinematic wide angle',
    providerId: 'nano-banana',
    subModelId: 'banana-2',
    aspect: '16:9',
    quality: '2K',
  ...
  },
  {
    ...
    prompt:
      'Digital art illustration, fantasy landscape, magical forest with glowing mushrooms, ethereal light rays, detailed environment, concept art style',
    providerId: 'seedream',
...
const DesignPage = () => {
  ...
  useEffect(() => {
    document.title = 'ERA2 — Генерация изображений'
  }, [])
  useEffect(() => {
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <div
                                ...
                                style={{ color: selectedSubModelId === s.id ? 'hsl(var(--primary))' : 'hsl(var(--foreground))' }}
                              >
                                {s.name}
                              </div>
                            </div>
