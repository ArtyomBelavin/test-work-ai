...
import { videoProviders, videoCarouselCards, videoPromptSuggestions } from '@/entities/ai-model'
...
const VideoPage = () => {
  ...
  useEffect(() => {
    document.title = 'ERA2 — Генерация видео'
  }, [])
  useEffect(() => {
                        ...
                        {p.subModels.map((s) => (
                          <button
                            ...
                            onClick={() => {
                              ...
                              setTimeout(() => handleModelSelect(p.id, s.id), 50)
                            }}
                            className={cn(
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <InlinePillDropdown
                    ...
                    options={(provider?.resolutionOptions || []).map((r) => ({
                      value: r,
                      label: r,
                      desc: r === '480p' ? 'Черновик' : r === '720p' ? 'Стандарт' : r === '1080p' ? 'Full HD' : undefined,
                    }))}
