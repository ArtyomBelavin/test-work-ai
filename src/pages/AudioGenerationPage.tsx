...
const models = [
  {
    name: 'ElevenLabs',
    description: 'Лидер в генерации голоса. Реалистичная озвучка, клонирование голоса, мультиязычность.',
    price: 'от 60',
  },
  {
    name: 'Suno',
    description: 'Генерация музыки по текстовому описанию. Создавайте треки любого жанра за секунды.',
    price: 'от 30',
  },
]
...
const useCases: { Icon: LucideIcon; title: string; description: string }[] = [
  {
    Icon: Mic,
    title: 'Озвучка видео',
    description: 'Профессиональная озвучка роликов для YouTube, Reels, TikTok. 29 языков, сотни голосов.',
  },
  {
    Icon: Megaphone,
    title: 'Реклама',
...
const benefits: { Icon: LucideIcon; title: string; description: string }[] = [
  ...
  },
  {
    ...
    description: 'Платите только за использование. Не нужна ежемесячная подписка ElevenLabs за $22.',
  },
]
...
export default function AudioGenerationPage() {
  ...
  useEffect(() => {
    setPageMeta('Генерация аудио — ИИ нейросети | ERA2.ai', 'ElevenLabs, Suno. Озвучка текста, создание музыки, клон голоса.')
  }, [])
      ...
      >
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto" style={{ color: 'var(--seo-text)' }}>
            Озвучка, музыка, клонирование голоса — 2 мощные нейросети в одном месте. Без VPN, с оплатой в рублях.
          </p>
          <Link
            to={cta}
